    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <g>
            <animateTransform attributeName="transform" type="rotate" values="360 50 50;0 50 50" keyTimes="0;1" dur="1s"
                repeatCount="indefinite" calcMode="spline" keySplines="0.5 0 0.5 1" begin="-0.125s"></animateTransform>
            <circle cx="50" cy="50" r="39.891" stroke="#28292f" stroke-width="14.4" fill="none" stroke-dasharray="0 300">
                <animate attributeName="stroke-dasharray" values="15 300;68.92669989939274 300;15 300" keyTimes="0;0.5;1"
                    dur="1s" repeatCount="indefinite" calcMode="linear" keySplines="0 0.4 0.6 1;0.4 0 1 0.6"
                    begin="-0.057499999999999996s"></animate>
            </circle>
            ...
            <circle cx="50" cy="50" r="32.771" stroke="#0a0a0a" stroke-width="1" fill="none" stroke-dasharray="0 300">
                <animate attributeName="stroke-dasharray" values="15 300;56.62422306793511 300;15 300" keyTimes="0;0.5;1"
                    dur="1s" repeatCount="indefinite" calcMode="linear" keySplines="0 0.4 0.6 1;0.4 0 1 0.6"
                    begin="-0.057499999999999996s"></animate>
            </circle>
            <circle cx="50" cy="50" r="47.171" stroke="#0a0a0a" stroke-width="1" fill="none" stroke-dasharray="0 300">
                <animate attributeName="stroke-dasharray" values="15 300;82.54236246005091 300;15 300" keyTimes="0;0.5;1"
                    dur="1s" repeatCount="indefinite" calcMode="linear" keySplines="0 0.4 0.6 1;0.4 0 1 0.6"
                    begin="-0.057499999999999996s"></animate>
            </circle>
        </g>
        ...
        <g>
            ...
            <path fill="#28292f" stroke="#0a0a0a" d="M97.2,50.1c0,6.1-1.2,12.2-3.5,17.9l-13.3-5.4c1.6-3.9,2.4-8.2,2.4-12.4">
            </path>
            <path fill="#ffffff"
            ...
            <path fill="#28292f" stroke="#0a0a0a"
