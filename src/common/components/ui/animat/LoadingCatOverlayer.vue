<template>
    <div class="fixed  inset-0  bg-[#0008] z-[100]">
        <svg class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" style="margin:auto;background:transparent;display:block;"
            width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
            <g>
                <animateTransform attributeName="transform" type="rotate" values="360 50 50;0 50 50" keyTimes="0;1"
                    dur="1.0101010101010102s" repeatCount="indefinite" calcMode="spline" keySplines="0.5 0 0.5 1"
                    begin="-0.11616161616161619s"></animateTransform>
                <circle cx="50" cy="50" r="39.891" stroke="#ffffff" stroke-width="14.4" fill="none"
                    stroke-dasharray="0 300">
                    <animate attributeName="stroke-dasharray" values="15 300;63.41256390744134 300;15 300"
                        keyTimes="0;0.5;1" dur="1.0101010101010102s" repeatCount="indefinite" calcMode="linear"
                        keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.05343434343434344s"></animate>
                </circle>
                <circle cx="50" cy="50" r="39.891" stroke="#eeeeee" stroke-width="7.2" fill="none"
                    stroke-dasharray="0 300">
                    <animate attributeName="stroke-dasharray" values="15 300;63.41256390744134 300;15 300"
                        keyTimes="0;0.5;1" dur="1.0101010101010102s" repeatCount="indefinite" calcMode="linear"
                        keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.05343434343434344s"></animate>
                </circle>
                <circle cx="50" cy="50" r="32.771" stroke="#136450" stroke-width="1" fill="none"
                    stroke-dasharray="0 300">
                    <animate attributeName="stroke-dasharray" values="15 300;52.09428522250031 300;15 300"
                        keyTimes="0;0.5;1" dur="1.0101010101010102s" repeatCount="indefinite" calcMode="linear"
                        keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.05343434343434344s"></animate>
                </circle>
                <circle cx="50" cy="50" r="47.171" stroke="#136450" stroke-width="1" fill="none"
                    stroke-dasharray="0 300">
                    <animate attributeName="stroke-dasharray" values="15 300;75.93897346324685 300;15 300"
                        keyTimes="0;0.5;1" dur="1.0101010101010102s" repeatCount="indefinite" calcMode="linear"
                        keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.05343434343434344s"></animate>
                </circle>
            </g>
            ...
            <g>
                ...
                <path fill="#ffffff" stroke="#136450"
            ...
            <g>
                <animateTransform attributeName="transform" type="rotate" values="360 50 50;0 50 50" keyTimes="0;1"
                    dur="1.0101010101010102s" repeatCount="indefinite" calcMode="spline" keySplines="0.5 0 0.5 1"
                    begin="-0.11616161616161619s"></animateTransform>
                <path fill="#eeeeee" stroke="#136450"
