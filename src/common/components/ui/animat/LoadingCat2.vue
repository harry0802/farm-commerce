    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <g>
            ...
            <circle cx="50" cy="50" r="39.891" stroke="#ffffff" stroke-width="14.4" fill="none" stroke-dasharray="0 300">
                <animate attributeName="stroke-dasharray" values="15 300;63.41256390744134 300;15 300" keyTimes="0;0.5;1"
                    dur="1.0101010101010102s" repeatCount="indefinite" calcMode="linear"
            ...
            <circle cx="50" cy="50" r="32.771" stroke="#136450" stroke-width="1" fill="none" stroke-dasharray="0 300">
                <animate attributeName="stroke-dasharray" values="15 300;52.09428522250031 300;15 300" keyTimes="0;0.5;1"
                    dur="1.0101010101010102s" repeatCount="indefinite" calcMode="linear"
                    keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.05343434343434344s"></animate>
            </circle>
            <circle cx="50" cy="50" r="47.171" stroke="#136450" stroke-width="1" fill="none" stroke-dasharray="0 300">
                <animate attributeName="stroke-dasharray" values="15 300;75.93897346324685 300;15 300" keyTimes="0;0.5;1"
                    dur="1.0101010101010102s" repeatCount="indefinite" calcMode="linear"
                    keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.05343434343434344s"></animate>
            </circle>
        </g>
        ...
        <g>
            ...
            <path fill="#ffffff" stroke="#136450" d="M97.2,50.1c0,6.1-1.2,12.2-3.5,17.9l-13.3-5.4c1.6-3.9,2.4-8.2,2.4-12.4">
            </path>
            <path fill="#eeeeee"
