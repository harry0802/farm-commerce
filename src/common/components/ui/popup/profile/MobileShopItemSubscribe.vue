<template>
    <DrawerRoot>
        ...
        <DrawerPortal>
            ...
            <DrawerContent
                class=" bg-white flex flex-col fixed  bottom-0 left-0 right-0  max-h-[96%] rounded-t-[30px] shadow-sm">
                ...
                <div class="  w-full mx-auto flex flex-col  p-[30px] rounded-t-[10px] ">
                    ...
                    <div class="  mt-auto h-[44px]  button-controll   flex gap-2    flex-row justify-end">
                        ...
                        <DrawerClose class="max-w-[140px] u-subscribe-btn cancel text-color-primary ">取消</DrawerClose>
                    </div>
                </div>
            </DrawerContent>
        </DrawerPortal>
